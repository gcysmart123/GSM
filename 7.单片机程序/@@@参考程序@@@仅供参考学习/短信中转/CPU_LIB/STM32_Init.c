...
void stm32_TimerSetup (void) {
  ...
  if (__TIMER_USED & 0x01) {                                // TIM1 used
    ...
    if (__TIMER_DETAILS & 0x01) {                           // detailed settings used
      TIM1->PSC = __TIM4_PSC;                               // set prescaler
      TIM1->ARR = __TIM4_ARR;                               // set auto-reload
    ...
    if (__TIMER_INTERRUPTS & 0x01) {                        // interrupts used
      ...
      NVIC->Enable[0] |= (1 << (TIM1_UP_IRQChannel & 0x1F));// enable interrupt
    }
  ...
  if (__TIMER_USED & 0x02) {                                // TIM2 used
    ...
    if (__TIMER_DETAILS & 0x02) {                           // detailed settings used
      TIM2->PSC = __TIM4_PSC;                               // set prescaler
      TIM2->ARR = __TIM4_ARR;                               // set auto-reload
    ...
    if (__TIMER_INTERRUPTS & 0x02) {                        // interrupts used
      ...
      NVIC->Enable[0] |= (1 << (TIM2_IRQChannel & 0x1F));   // enable interrupt
    }
  ...
  if (__TIMER_USED & 0x04) {                                // TIM3 used
    ...
    if (__TIMER_DETAILS & 0x04) {                           // detailed settings used
      TIM3->PSC = __TIM4_PSC;                               // set prescaler
      TIM3->ARR = __TIM4_ARR;                               // set auto-reload
    ...
    if (__TIMER_INTERRUPTS & 0x04) {                        // interrupts used
      ...
      NVIC->Enable[0] |= (1 << (TIM3_IRQChannel & 0x1F));   // enable interrupt
    }
  ...
  if (__TIMER_USED & 0x08) {                                // TIM4 used
    ...
    if (__TIMER_INTERRUPTS & 0x08) {                        // interrupts used
      ...
      NVIC->Enable[0] |= (1 << (TIM4_IRQChannel & 0x1F));   // enable interrupt
    }
...
void stm32_UsartSetup (void) {
  ...
  if (__USART_USED & 0x02) {                                // USART2 used
    ...
    if (__USART_INTERRUPTS & 0x02) {                        // interrupts used
      ...
      NVIC->Enable[1] |= (1 << (USART2_IRQChannel & 0x1F)); // enable interrupt
    }
  ...
  if (__USART_USED & 0x04) {                                // USART3 used
    ...
    if (__USART_INTERRUPTS & 0x04) {                        // interrupts used
      ...
      NVIC->Enable[1] |= (1 << (USART3_IRQChannel & 0x1F)); // enable interrupt
    }
...
void stm32_ExtiSetup (void) {
  ...
  if (__EXTI_USED & (1 << 0)) {                             // EXTI0 used
    ...
    if (__EXTI_INTERRUPTS & (1 << 0)) {                     // interrupt used
      NVIC->Enable[0] |= (1 << (EXTI0_IRQChannel & 0x1F));  // enable interrupt EXTI 0
    }
  } // end EXTI0 used
  ...
  if (__EXTI_USED & (1 << 1)) {                             // EXTI1 used
    ...
    if (__EXTI_INTERRUPTS & (1 << 1)) {                     // interrupt used
      NVIC->Enable[0] |= (1 << (EXTI1_IRQChannel & 0x1F));  // enable interrupt EXTI 1
    }
  } // end EXTI1 used
  ...
  if (__EXTI_USED & (1 << 2)) {                             // EXTI2 used
    ...
    if (__EXTI_INTERRUPTS & (1 << 2)) {                     // interrupt used
      NVIC->Enable[0] |= (1 << (EXTI2_IRQChannel & 0x1F));  // enable interrupt EXTI 2
    }
  } // end EXTI2 used
  ...
  if (__EXTI_USED & (1 << 3)) {                             // EXTI3 used
    ...
    if (__EXTI_INTERRUPTS & (1 << 3)) {                     // interrupt used
      NVIC->Enable[0] |= (1 << (EXTI3_IRQChannel & 0x1F));  // enable interrupt EXTI 3
    }
  } // end EXTI3 used
  ...
  if (__EXTI_USED & (1 << 4)) {                             // EXTI4 used
    ...
    if (__EXTI_INTERRUPTS & (1 << 4)) {                     // interrupt used
      NVIC->Enable[0] |= (1 << (EXTI4_IRQChannel & 0x1F));  // enable interrupt EXTI 4
    }
  } // end EXTI4 used
  ...
  if (__EXTI_USED & (1 << 5)) {                             // EXTI5 used
    ...
    if (__EXTI_INTERRUPTS & (1 << 5)) {                     // interrupt used
      NVIC->Enable[0] |= (1 << (EXTI9_5_IRQChannel & 0x1F));// enable interrupt EXTI 9..5
    }
  } // end EXTI5 used
  ...
  if (__EXTI_USED & (1 << 10)) {                            // EXTI10 used
    ...
    if (__EXTI_INTERRUPTS & (1 << 10)) {                    // interrupt used
      NVIC->Enable[1] |= (1 << (EXTI15_10_IRQChannel & 0x1F));// enable interrupt EXTI 10..15
    }
  } // end EXTI10 used
...
void stm32_TamperSetup (void) {
  ...
  if (BKP->CSR & (1<<2)) {                                  // Tamper interrupt enable ?
    NVIC->Enable[0] |= (1 << (TAMPER_IRQChannel & 0x1F));   // enable interrupt
  }
